    ...
    e.fn.prettyEmbed = function(n) {
      function i(i) {
        var o = i.find("img").outerWidth(!0),
          ...
          a = "",
          s = "";
        i.attr("data-pe-videoid") !== t ? s = i.attr("data-pe-videoid") : n.videoID !== t ? s = n.videoID : (s = t, console.error("PrettyEmbed.js Error:  Misformed or missing video ID.")), ("false" === i.attr("data-pe-show-info") || n.showInfo === !1) && (a += "&showinfo=0"), ("false" === i.attr("data-pe-show-controls") || n.showControls === !1) && (a += "&controls=0"), ("true" === i.attr("data-pe-loop") || n.loop === !0) && (a += "&loop=1"), ("true" === i.attr("data-pe-closed-captions") || n.closedCaptions === !0) && (a += "&cc_load_policy=1"), (i.attr("data-pe-localization") !== t || n.localization !== t) && (i.attr("data-pe-localization") !== t ? a += "&hl=" + i.attr("data-pe-localization") : n.localization !== t && (a += "&hl=" + n.localization)), ("light" === i.attr("data-pe-color-scheme") || "light" === n.colorScheme) && (a += "&theme=light"), a += "false" === i.attr("data-pe-show-related") || n.showRelated === !1 ? "&rel=0" : "&rel=1", i.html('<iframe width="' + o + '" height="' + r + '" style="border:none;" src="//www.youku.com/v_show/' + s + "?autoplay=1" + a + '"></iframe>').addClass("play"), n.useFitVids && e.isFunction(e.fn.fitVids) && i.parent().fitVids()
      }
      ...
      r = e(0 === e(this).length ? ".pretty-embed" : this), r.each(function() {
        ...
        var i, r, a, s, l, c, u, d, p = "",
          f = "",
          h = "";
        if (p = e(this).attr("data-pe-videoid") !== t ? e(this).attr("data-pe-videoid") : e(this).attr("href") !== t ? o(e(this).attr("href")) : n.videoID, f = e(this).attr("data-pe-preview-size") !== t ? e(this).attr("data-pe-preview-size") : n.previewSize !== t ? n.previewSize : t, h = e(this).attr("data-pe-custom-preview-image") !== t ? e(this).attr("data-pe-custom-preview-image") : n.customPreviewImage !== t ? n.customPreviewImage : t, r = e(this).attr("data-pe-show-info") !== t ? e(this).attr("data-pe-show-info") : n.showInfo !== t ? n.showInfo : t, a = e(this).attr("data-pe-show-controls") !== t ? e(this).attr("data-pe-show-controls") : n.showControls !== t ? n.showControls : t, s = e(this).attr("data-pe-loop") !== t ? e(this).attr("data-pe-loop") : n.loop !== t ? n.loop : t, l = e(this).attr("data-pe-closed-captions") !== t ? e(this).attr("data-pe-closed-captions") : n.closedCaptions !== t ? n.closedCaptions : t, c = e(this).attr("data-pe-localization") !== t ? e(this).attr("data-pe-localization") : n.localization !== t ? n.localization : t, u = e(this).attr("data-pe-color-scheme") !== t ? e(this).attr("data-pe-color-scheme") : n.colorScheme !== t ? n.colorScheme : t, d = e(this).attr("data-pe-show-related") !== t ? e(this).attr("data-pe-show-related") : n.showRelated !== t ? n.showRelated : t, e(this).is("a") && (i = e("<div />").addClass("pretty-embed"), i.attr("data-pe-videoid", p).attr("data-pe-preview-size", f).attr("data-pe-custom-preview-image", h).attr("data-pe-show-info", r).attr("data-pe-show-controls", a).attr("data-pe-loop", s).attr("data-pe-closed-captions", l).attr("data-pe-localization", c).attr("data-pe-color-scheme", u).attr("data-pe-show-related", d), e(this).after(i)), h !== t && "" !== h) e(this).html('<img src="' + h + '" width="100%" alt="优酷视频" />');
        else {
          var m = "";
          switch (f) {
            case "thumb-default":
          ...
          e(this).html('<img src="//img.youtube.com/vi/' + p + "/" + m + '.jpg" width="100%" alt="优酷视频" />')
        }
...
window.Carousel = function() {
  ...
  for (n = $("#menus a"), t = $(".news-container"), o = "", e = n.first(), i = function() {
      var n, i;
  ...
  r = 0, n = $(window), t = $(".top"), e = $("#nav"), FastClick.attach(document.body), $("p").each(function() {
  ...
  }), page("index.html", "reservation") && (new Carousel({
    ...
    showRelated: !1,
    useFitVids: !0
  }), page("about") && $("#grape-video").prettyEmbed({
    videoID: "XMTQ2MDYxMTQxNg",
    customPreviewImage: "../static/images/800-800-7.jpg",
    showInfo: !1,
    showControls: !1,
    loop: !1,
    colorScheme: "dark",
  ...
  a = !0, o = !1, i = {
    ...
    return $("form").addClass("loading"), $.post("/subscribe/", t, function(t) {
